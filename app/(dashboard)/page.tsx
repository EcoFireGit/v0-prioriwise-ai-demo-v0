        ...
        <div className="mx-auto w-full max-w-7xl space-y-6">
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-foreground">
              {persona} Insights
              <span className="ml-2 text-sm font-normal text-muted-foreground">({insights.length} opportunities)</span>
            </h3>
            ...
            <div className="mt-8 flex justify-center">
              <Button
                ...
                variant="outline"
                className="bg-transparent font-heading text-primary hover:bg-secondary"
              >
                Return to Dashboard
              </Button>
            </div>
